 ...
 */
    function errorPlacementQTip(error, element) {
        var elem = $(element),
            corners = ['right center', 'center left'],
    ...
    /**
     * 验证失败给目标控件设置样式 jquery.validate.js highlight
     * @param {} element
     * @param {} errorClass
     * @param {} validClass
     * @returns {} 
    ...
    /**
     * 验证成功给目标控件清理样式 jquery.validate.js unhighlight
     * @param {} element
     * @param {} errorClass
     * @param {} validClass
     * @returns {} 
        ...
        if (!result) {
            result = {
                options: {  // options structure passed to jQuery Validate's validate() method
                    ...
                    errorElement: "span",
                    errorPlacement: $.proxy(errorPlacementQTip, form),//onError
                    invalidHandler: $.proxy(onErrors, form),
                    messages: {},
                    rules: {},
                    success: $.proxy(successQTip, form)//onSuccess
                },
